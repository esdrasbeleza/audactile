...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Fri May 21 00:02:31 2010
# Project:  Player.pro
# Template: app
...
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS)  -L/usr/lib -ltag -lQtWebKit -L/usr/lib -L/usr/X11R6/lib64 -lsqlite3 -lQtXmlPatterns -lQtNetwork -lphonon -lQtSql -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
compiler_moc_header_make_all: moc_filesystemwidget.cpp moc_playlistwidget.cpp moc_playerbar.cpp moc_mainwindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_filesystemwidget.cpp moc_playlistwidget.cpp moc_playerbar.cpp moc_mainwindow.cpp
