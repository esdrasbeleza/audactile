...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Thu Jul 1 18:00:37 2010
# Project:  Player.pro
# Template: app
...
SOURCES       = src/mainwindow/mainnotebook/collection/collectiontreewidget.cpp \
		...
		src/settings/settingsdialog.cpp moc_filesystemwidget.cpp \
...
moc_playerbar.cpp: src/settings/settingsdialog.h \
		src/mainwindow/playerbar.h
...
settingsdialog.o: src/settings/settingsdialog.cpp src/settings/settingsdialog.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o settingsdialog.o src/settings/settingsdialog.cpp
