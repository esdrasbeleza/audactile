...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Thu Jul 1 16:04:31 2010
# Project:  Player.pro
# Template: app
...
SOURCES       = src/mainwindow/mainnotebook/collection/collectiontreewidget.cpp \
		...
		src/main.cpp \
		src/settings/applicationsettings.cpp moc_filesystemwidget.cpp \
