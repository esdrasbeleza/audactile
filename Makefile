...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Sat Sep 11 02:43:26 2010
# Project:  Player.pro
# Template: app
...
SOURCES       = src/mainwindow/mainnotebook/collection/collectiontreewidget.cpp \
		...
		src/mainwindow/mainnotebook/collection/collectiontreewidgetitem.cpp moc_collectiontreewidget.cpp \
...
collectiontreewidgetitem.o: src/mainwindow/mainnotebook/collection/collectiontreewidgetitem.cpp src/mainwindow/mainnotebook/collection/collectiontreewidgetitem.h \
		src/iconfactory.h \
		src/music.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o collectiontreewidgetitem.o src/mainwindow/mainnotebook/collection/collectiontreewidgetitem.cpp
