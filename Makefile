...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Fri Sep 3 00:52:44 2010
# Project:  Player.pro
# Template: app
...
SOURCES       = src/mainwindow/mainnotebook/collection/collectiontreewidget.cpp \
		...
		src/music.cpp \
		src/collection/collectiondatabase.cpp moc_filesystemwidget.cpp \
